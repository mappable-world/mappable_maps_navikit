        ...
        .lookup<
            NativeFunction<
                Pointer<Void> Function(Bool, Int64, NativeString,
                    Handle)>>('mappable_maps_flutter_new_image_provider')
        .asFunction();
...
Pointer<Void> Function(Pointer<NativeFrame>, int, int, NativeString)
    newAnimatedImageProviderFromFrames = library
        .lookup<
            ...
            'mappable_maps_flutter_new_animated_image_provider_from_frames')
        .asFunction(isLeaf: true);
...
Pointer<Void> Function(int, Object, NativeString)
    newAnimatedImageProviderFromApng = library
        .lookup<
            ...
            'mappable_maps_flutter_new_animated_image_provider_from_apng')
        .asFunction();
        ...
        .lookup<
            NativeFunction<
                Pointer<Void> Function(Int64, Pointer<Void>,
                    Pointer<Void>)>>('mappable_maps_flutter_new_view_provider')
        .asFunction(isLeaf: true);
        ...
        .lookup<
            NativeFunction<
                Pointer<Void> Function(
                    ...
                    NativeString,
                    Pointer<Void>,
                    Handle)>>('mappable_maps_flutter_new_model_provider')
        .asFunction();
...
Pointer<Void> Function(NativeString, int, Object) newAnimatedModelProvider =
    library
        .lookup<
                NativeFunction<
                    Pointer<Void> Function(NativeString, Int64, Handle)>>(
            'mappable_maps_flutter_new_animated_model_provider')
        .asFunction();
