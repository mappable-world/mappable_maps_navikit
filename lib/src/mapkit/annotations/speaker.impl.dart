...
final _LocalizedPhrase_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_annotations_LocalizedPhrase_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _LocalizedPhrase_init = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_annotations_LocalizedPhrase_init')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _LocalizedPhrase_get_tokens = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_annotations_LocalizedPhrase_get_tokens')
        .asFunction(isLeaf: true);
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _LocalizedPhrase_get_text = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_annotations_LocalizedPhrase_get_text')
        .asFunction(isLeaf: true);
final core.int Function(ffi.Pointer<ffi.Void>) _LocalizedPhrase_get_language =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_annotations_LocalizedPhrase_get_language')
        .asFunction(isLeaf: true);
...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _SpeakersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_annotations_Speaker_setSendPort')
        .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Double Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_mapkit_annotations_Speaker_new')
        .asFunction(isLeaf: true);

final _Speaker_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_annotations_Speaker_free');
