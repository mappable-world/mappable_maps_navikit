...
final _GeoObjectSession_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_GeoObjectSession_free');

final void Function(ffi.Pointer<ffi.Void>) _GeoObjectSession_cancel = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_GeoObjectSession_cancel')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _GeoObjectSession_retry = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_GeoObjectSession_retry')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_GeoObjectSession_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_GeoObjectSession_GeoObjectSessionGeoObjectListener_setSendPort')
    .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_mapkit_GeoObjectSession_GeoObjectSessionGeoObjectListener_new')
        .asFunction(isLeaf: true);
