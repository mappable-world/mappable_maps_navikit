...
final _Image_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_Image_free');

final ffi.Pointer<ffi.Void> Function(
    native_types.NativeString,
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _Image_init = lib.library
    .lookup<
        ffi.NativeFunction<
            ffi.Pointer<ffi.Void> Function(
                native_types.NativeString,
                ffi.Pointer<ffi.Void>,
                ffi.Pointer<ffi.Void>)>>('mappable_flutter_mapkit_Image_init')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _Image_get_urlTemplate = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_Image_get_urlTemplate')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>) _Image_get_sizes =
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_Image_get_sizes')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>) _Image_get_tags =
    lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_Image_get_tags')
        .asFunction(isLeaf: true);
...
final ImageImageSizeNative Function(
    ...
    _ImageImageSizeNativeInit = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_Image_ImageImageSize_init')
        .asFunction(isLeaf: true);
