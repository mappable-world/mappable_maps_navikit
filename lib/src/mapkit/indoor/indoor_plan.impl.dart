...
final IndoorLevelNative Function(
    ...
    native_types.NativeString,
    core
        .bool) _IndoorLevelNativeInit = lib.library
    .lookup<
        ffi.NativeFunction<
            IndoorLevelNative Function(
                native_types.NativeString,
                native_types.NativeString,
                ffi.Bool)>>('mappable_flutter_mapkit_indoor_IndoorLevel_init')
...
final _IndoorPlan_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_indoor_IndoorPlan_free');
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _IndoorPlan_get_levels = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_indoor_IndoorPlan_get_levels')
        .asFunction();
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _IndoorPlan_get_activeLevelId = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_indoor_IndoorPlan_get_activeLevelId')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeString)
    _IndoorPlan_set_activeLevelId = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_indoor_IndoorPlan_set_activeLevelId')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_indoor_IndoorPlan_set_')
    .asFunction(isLeaf: true);
