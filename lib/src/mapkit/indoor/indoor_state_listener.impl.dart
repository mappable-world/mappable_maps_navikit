...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _IndoorStateListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_indoor_IndoorStateListener_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, native_types.NativeString)>>)>>('mappable_flutter_mapkit_indoor_IndoorStateListener_new')
        .asFunction(isLeaf: true);

final _IndoorStateListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_indoor_IndoorStateListener_free');
