...
final UriNative Function(native_types.NativeString) _UriNativeInit = lib.library
    .lookup<ffi.NativeFunction<UriNative Function(native_types.NativeString)>>(
        'mappable_flutter_mapkit_uri_Uri_init')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _UriObjectMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_uri_UriObjectMetadata_downcast')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _UriObjectMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_uri_UriObjectMetadata_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function() _UriObjectMetadata_name = lib.library
    .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
        'mappable_flutter_mapkit_uri_UriObjectMetadata_name')
    .asFunction(isLeaf: true);

final _UriObjectMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_uri_UriObjectMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _UriObjectMetadata_init = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_uri_UriObjectMetadata_init')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _UriObjectMetadata_get_uris = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_uri_UriObjectMetadata_get_uris')
        .asFunction(isLeaf: true);
