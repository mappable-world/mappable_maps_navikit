...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _StorageErrorListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_storage_StorageErrorListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _StorageErrorListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_storage_StorageErrorListener_new')
        .asFunction(isLeaf: true);

final _StorageErrorListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_storage_StorageErrorListener_free');
