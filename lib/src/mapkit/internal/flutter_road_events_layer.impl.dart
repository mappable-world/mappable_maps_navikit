...
final _InternalDefaultStyleProvider_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_internal_InternalDefaultStyleProvider_free');
...
final core.bool Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_internal_InternalDefaultStyleProvider_provideStyle')
    .asFunction();
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_internal_InternalDefaultStyleProvider_provideHighlightCircleStyle')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
        .int) _InternalDefaultStyleProvider_set = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_mapkit_internal_InternalDefaultStyleProvider_set_')
...
final ffi.Pointer<ffi.Void> Function()
    _DefaultStyleProviderFactory_createDefaultStyleProvider = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
            'mappable_flutter_mapkit_internal_InternalDefaultStyleProviderFactory_createDefaultStyleProvider')
        .asFunction();
