...
final _SpannableString_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_SpannableString_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        native_types.NativeString, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_SpannableString_init')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _SpannableString_get_text = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_SpannableString_get_text')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SpannableString_get_spans = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_SpannableString_get_spans')
        .asFunction(isLeaf: true);
...
final SpannableStringSpanNative Function(core.int, core.int)
    _SpannableStringSpanNativeInit = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_SpannableString_SpannableStringSpan_init')
        .asFunction(isLeaf: true);
