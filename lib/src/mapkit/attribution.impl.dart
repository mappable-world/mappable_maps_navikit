...
final _Attribution_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_Attribution_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _Attribution_init = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_Attribution_init')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _Attribution_get_author = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_Attribution_get_author')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _Attribution_get_link = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_Attribution_get_link')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _Attribution_get_avatarImage = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_Attribution_get_avatarImage')
        .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    AttributionAuthorNative Function(native_types.NativeString,
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_Attribution_AttributionAuthor_init')
        .asFunction(isLeaf: true);
...
final AttributionLinkNative Function(native_types.NativeString)
    _AttributionLinkNativeInit = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_Attribution_AttributionLink_init')
        .asFunction(isLeaf: true);
