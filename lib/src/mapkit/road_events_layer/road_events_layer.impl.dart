...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayerListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _RoadEventsLayerListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_road_events_layer_RoadEventsLayerListener_new')
        .asFunction(isLeaf: true);

final _RoadEventsLayerListener_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_mapkit_road_events_layer_RoadEventsLayerListener_free');
...
final HighlightedRoadEventNative Function(
  ...
  core.int,
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_layer_HighlightedRoadEvent_init')
    .asFunction(isLeaf: true);
...
final _RoadEventsLayer_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _RoadEventsLayer_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_check')
    .asFunction(isLeaf: true);
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_addListener')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_removeListener')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    native_types
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_selectRoadEvent')
    .asFunction();
final void Function(
    ffi
        .Pointer<ffi.Void>) _RoadEventsLayer_deselectRoadEvent = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_deselectRoadEvent')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core.int,
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_setRoadEventVisibleOnRoute')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _RoadEventsLayer_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_layer_RoadEventsLayer_set_')
    .asFunction(isLeaf: true);
