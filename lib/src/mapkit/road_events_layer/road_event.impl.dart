...
final _RoadEvent_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_road_events_layer_RoadEvent_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        native_types.NativeString,
                        ffi.Bool)>>(
            'mappable_flutter_mapkit_road_events_layer_RoadEvent_init')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _RoadEvent_get_id = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_road_events_layer_RoadEvent_get_id')
        .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_point.PointNative Function(
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_road_events_layer_RoadEvent_get_position')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _RoadEvent_get_tags = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_road_events_layer_RoadEvent_get_tags')
        .asFunction(isLeaf: true);
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _RoadEvent_get_caption = lib.library
        .lookup<
                ffi.NativeFunction<
                    native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_road_events_layer_RoadEvent_get_caption')
        .asFunction(isLeaf: true);
final core.bool Function(ffi.Pointer<ffi.Void>) _RoadEvent_get_isInFuture = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_layer_RoadEvent_get_isInFuture')
    .asFunction(isLeaf: true);
