...
final _DummyLocationManager_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_DummyLocationManager_free');
...
final void Function(
    ...
    _DummyLocationManager_setLocation = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_location_DummyLocationManager_setLocation')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _DummyLocationManager_set =
    lib
        ...
        .lookup<
            ...
            'mappable_flutter_mapkit_location_DummyLocationManager_set_')
