...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _LocationListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_location_LocationListener_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>)>>('mappable_flutter_mapkit_location_LocationListener_new')
        .asFunction(isLeaf: true);

final _LocationListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_LocationListener_free');
