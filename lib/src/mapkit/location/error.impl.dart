...
final _LocationUnavailableError_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_LocationUnavailableError_free');
final core.bool Function(ffi.Pointer<ffi.Void>)
    _LocationUnavailableError_check = lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_location_LocationUnavailableError_check')
...
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _LocationUnavailableError_set = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_location_LocationUnavailableError_set_')
        .asFunction(isLeaf: true);
