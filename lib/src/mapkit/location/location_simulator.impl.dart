...
final LocationSettingsNative Function() _LocationSettingsFactory_fineSettings = lib
    .library
    .lookup<ffi.NativeFunction<LocationSettingsNative Function()>>(
        'mappable_flutter_mapkit_location_LocationSettingsFactory_fineSettings')
    .asFunction();
final LocationSettingsNative Function()
    _LocationSettingsFactory_coarseSettings = lib.library
        .lookup<ffi.NativeFunction<LocationSettingsNative Function()>>(
            'mappable_flutter_mapkit_location_LocationSettingsFactory_coarseSettings')
        .asFunction();
...
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _LocationSimulator_startSimulation = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
