...
final LocationSubscriptionSettingsNative Function(
    core.int,
    core
        .int) _LocationSubscriptionSettingsNativeInit = lib.library
    .lookup<
            ffi.NativeFunction<
                LocationSubscriptionSettingsNative Function(
                    ffi.Int64, ffi.Int64)>>(
        'mappable_flutter_mapkit_location_LocationSubscriptionSettings_init')
...
final _LocationManager_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_LocationManager_free');
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ...
                    LocationSubscriptionSettingsNative,
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_LocationManager_subscribeForLocationUpdates')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_location_LocationManager_requestSingleUpdate')
    .asFunction();
    ...
    _LocationManager_unsubscribe = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_location_LocationManager_unsubscribe')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _LocationManager_suspend = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_LocationManager_suspend')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _LocationManager_resume = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_location_LocationManager_resume')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _LocationManager_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_location_LocationManager_set_')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function()
    _LocationManagerUtils_get_lastKnownLocation = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
            'mappable_flutter_mapkit_location_LocationManagerUtils_get_lastKnownLocation')
        .asFunction(isLeaf: true);
