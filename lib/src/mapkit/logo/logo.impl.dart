...
final void Function(
    ...
    _Logo_setAlignment = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_logo_Logo_setAlignment')
        .asFunction();
final void Function(
    ...
    _Logo_setPadding = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_logo_Logo_setPadding')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Logo_set = lib.library
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_logo_Logo_set_')
    .asFunction(isLeaf: true);
