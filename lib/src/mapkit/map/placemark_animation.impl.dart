...
final void Function(ffi.Pointer<ffi.Void>, core.bool)
    _PlacemarkAnimation_set_reversed = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkAnimation_set_reversed')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkAnimation_setIcon')
        .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi.Pointer<ffi.Void>,
    mapkit_map_icon_style.IconStyleNative,
    ffi
        .Pointer<ffi.Void>) _PlacemarkAnimation_setIconWithCallback = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ...
                    mapkit_map_icon_style.IconStyleNative,
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkAnimation_setIconWithCallback')
    .asFunction();
final void Function(
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>,
                        mapkit_map_icon_style.IconStyleNative)>>(
            'mappable_flutter_mapkit_map_PlacemarkAnimation_setIconStyle')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _PlacemarkAnimation_play = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkAnimation_play')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _PlacemarkAnimation_playWithCallback = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkAnimation_playWithCallback')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _PlacemarkAnimation_resume = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkAnimation_resume')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _PlacemarkAnimation_stop = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkAnimation_stop')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _PlacemarkAnimation_pause = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkAnimation_pause')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _PlacemarkAnimation_set =
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkAnimation_set_')
        .asFunction(isLeaf: true);
