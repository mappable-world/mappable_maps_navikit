...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _DataProviderWithIdsetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_DataProviderWithId_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_mapkit_map_DataProviderWithId_new')
        .asFunction(isLeaf: true);

final void Function(ffi.Pointer<ffi.Void>) _DataProviderWithId_free = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_DataProviderWithId_free')
    .asFunction(isLeaf: true);
final core.bool Function(ffi.Pointer<ffi.Void>) _DataProviderWithId_exists = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_DataProviderWithId_exists')
    .asFunction(isLeaf: true);
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_map_DataProviderWithId_providerId_invokeOnResult')
    .asFunction(isLeaf: true);
...
final void Function(
    ffi.Pointer<ffi.Void>,
    native_types
        .NativeString) _DataProviderWithIdloadInvokeOnResult = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, native_types.NativeString)>>(
        'mappable_flutter_mapkit_map_DataProviderWithId_load_invokeOnResult')
    .asFunction(isLeaf: true);
