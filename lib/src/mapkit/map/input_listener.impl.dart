...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _MapInputListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapInputListener_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, mapkit_geometry_point.PointNative)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, mapkit_geometry_point.PointNative)>>)>>('mappable_flutter_mapkit_map_MapInputListener_new')
        .asFunction(isLeaf: true);

final _MapInputListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapInputListener_free');
