...
final _CompositeIcon_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_CompositeIcon_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _CompositeIcon_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_CompositeIcon_check')
...
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeString,
    ...
    _CompositeIcon_setIcon = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_CompositeIcon_setIcon')
        .asFunction();
final void Function(
        ffi.Pointer<ffi.Void>,
        native_types.NativeString,
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_map_icon_style.IconStyleNative,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_CompositeIcon_setIconWithCallback')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeString,
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        native_types.NativeString,
                        mapkit_map_icon_style.IconStyleNative)>>(
            'mappable_flutter_mapkit_map_CompositeIcon_setIconStyle')
        .asFunction();
final ffi.Pointer<ffi.Void> Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_CompositeIcon_icon')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeString)
    _CompositeIcon_removeIcon = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, native_types.NativeString)>>(
            'mappable_flutter_mapkit_map_CompositeIcon_removeIcon')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _CompositeIcon_removeAll = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_CompositeIcon_removeAll')
    .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_CompositeIcon_set_')
    .asFunction(isLeaf: true);
