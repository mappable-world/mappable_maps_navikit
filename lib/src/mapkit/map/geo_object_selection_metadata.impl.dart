...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectSelectionMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_downcast')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectSelectionMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function() _GeoObjectSelectionMetadata_name =
    lib.library
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_name')
        .asFunction(isLeaf: true);

final _GeoObjectSelectionMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_init')
        .asFunction(isLeaf: true);

final native_types.NativeString Function(
    ffi
        .Pointer<ffi.Void>) _GeoObjectSelectionMetadata_get_objectId = lib
    .library
    .lookup<
            ffi.NativeFunction<
                native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_get_objectId')
    .asFunction(isLeaf: true);
final native_types.NativeString Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_get_dataSourceName')
    .asFunction(isLeaf: true);
final native_types.NativeString Function(
    ffi
        .Pointer<ffi.Void>) _GeoObjectSelectionMetadata_get_layerId = lib
    .library
    .lookup<
            ffi.NativeFunction<
                native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_get_layerId')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
        .Pointer<ffi.Void>) _GeoObjectSelectionMetadata_get_groupId = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_GeoObjectSelectionMetadata_get_groupId')
    .asFunction(isLeaf: true);
