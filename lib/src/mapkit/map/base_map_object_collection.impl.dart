...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _PlacemarkCreatedCallbacksetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkCreatedCallback_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _PlacemarkCreatedCallback_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkCreatedCallback_new')
        .asFunction(isLeaf: true);
...
final _BaseMapObjectCollection_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseMapObjectCollection_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _BaseMapObjectCollection_check =
    lib
        .library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_BaseMapObjectCollection_check')
        .asFunction(isLeaf: true);
    ...
    _BaseMapObjectCollection_traverse = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_BaseMapObjectCollection_traverse')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _BaseMapObjectCollection_remove = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_BaseMapObjectCollection_remove')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _BaseMapObjectCollection_clear = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseMapObjectCollection_clear')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _BaseMapObjectCollection_addListener = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_BaseMapObjectCollection_addListener')
        .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _BaseMapObjectCollection_removeListener = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseMapObjectCollection_removeListener')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _BaseMapObjectCollection_set = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_BaseMapObjectCollection_set_')
        .asFunction(isLeaf: true);
