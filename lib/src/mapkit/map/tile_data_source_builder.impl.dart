...
final _BaseTileDataSourceBuilder_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_free');
final core.bool Function(ffi.Pointer<ffi.Void>)
    _BaseTileDataSourceBuilder_check = lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_check')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_setTileUrlProvider')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_setTileProvider')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _BaseTileDataSourceBuilder_setProjection = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_setProjection')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _BaseTileDataSourceBuilder_setZoomRanges = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_setZoomRanges')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
        .int) _BaseTileDataSourceBuilder_setTileFormat = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_setTileFormat')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _BaseTileDataSourceBuilder_set = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
            'mappable_flutter_mapkit_map_BaseTileDataSourceBuilder_set_')
        .asFunction(isLeaf: true);
