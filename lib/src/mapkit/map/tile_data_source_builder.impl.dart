...
class TileDataSourceBuilderImpl
  ...
  void setTileUrlProvider(
    ...
    _TileDataSourceBuilder_setTileUrlProvider(
        ptr,
  ...
  void setTileProvider(mapkit_tiles_tile_provider.TileProvider tileProvider) {
    _TileDataSourceBuilder_setTileProvider(ptr,
  ...
  void setProjection(mapkit_geometry_geo_projection.Projection projection) {
    _TileDataSourceBuilder_setProjection(ptr,
  ...
  void setZoomRanges(core.List<mapkit_zoom_range.ZoomRangeIdl> zoomRanges) {
    _TileDataSourceBuilder_setZoomRanges(
        ptr,
  ...
  void setTileFormat(mapkit_layers_tile_format.TileFormat format) {
    _TileDataSourceBuilder_setTileFormat(
...
final _TileDataSourceBuilder_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_TileDataSourceBuilder_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _TileDataSourceBuilder_check =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_TileDataSourceBuilder_check')
        .asFunction(isLeaf: true);

final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _TileDataSourceBuilder_setTileUrlProvider = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_TileDataSourceBuilder_setTileUrlProvider')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _TileDataSourceBuilder_setTileProvider = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_TileDataSourceBuilder_setTileProvider')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _TileDataSourceBuilder_setProjection = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_TileDataSourceBuilder_setProjection')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _TileDataSourceBuilder_setZoomRanges = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_TileDataSourceBuilder_setZoomRanges')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _TileDataSourceBuilder_setTileFormat = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
            'mappable_flutter_mapkit_map_TileDataSourceBuilder_setTileFormat')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _TileDataSourceBuilder_set = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
            'mappable_flutter_mapkit_map_TileDataSourceBuilder_set_')
        .asFunction(isLeaf: true);
...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _CreateTileDataSourcesetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_CreateTileDataSource_setSendPort')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _CreateTileDataSource_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_CreateTileDataSource_new')
        .asFunction(isLeaf: true);
