...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectInspectionMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_downcast')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectInspectionMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function() _GeoObjectInspectionMetadata_name =
    lib.library
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_name')
        .asFunction(isLeaf: true);

final _GeoObjectInspectionMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(native_types.NativeString, core.int)
    _GeoObjectInspectionMetadata_init = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_init')
        .asFunction(isLeaf: true);

final native_types.NativeString Function(
    ffi
        .Pointer<ffi.Void>) _GeoObjectInspectionMetadata_get_layerId = lib
    .library
    .lookup<
            ffi.NativeFunction<
                native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_get_layerId')
    .asFunction(isLeaf: true);
final core.int Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_GeoObjectInspectionMetadata_get_objectType')
    .asFunction(isLeaf: true);
