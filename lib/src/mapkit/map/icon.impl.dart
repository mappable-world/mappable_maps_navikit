...
final mapkit_map_icon_style.IconStyleNative Function(ffi.Pointer<ffi.Void>)
    _Icon_get_style = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Icon_get_style')
        .asFunction();
final void Function(
    ...
    _Icon_set_style = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Icon_set_style')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Icon_setImage = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Icon_setImage')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        mapkit_map_icon_style.IconStyleNative)>>(
            'mappable_flutter_mapkit_map_Icon_setImageWithStyle')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_map_icon_style.IconStyleNative,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_Icon_setImageWithCallback')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Icon_setView = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_Icon_setView')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        mapkit_map_icon_style.IconStyleNative)>>(
            'mappable_flutter_mapkit_map_Icon_setViewWithStyle')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
        mapkit_map_icon_style.IconStyleNative, ffi.Pointer<ffi.Void>)
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_map_icon_style.IconStyleNative,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_Icon_setViewWithCallback')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Icon_set = lib.library
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_Icon_set_')
    .asFunction(isLeaf: true);
