...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _MapSizeChangedListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapSizeChangedListener_setSendPort')
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ffi.Pointer<
                            ffi
                            .NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, ffi.Int, ffi.Int)>>)>>(
            'mappable_flutter_mapkit_map_MapSizeChangedListener_new')
        .asFunction(isLeaf: true);

final _MapSizeChangedListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapSizeChangedListener_free');
