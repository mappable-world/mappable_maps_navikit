...
final mapkit_map_model_style.ModelStyleNative Function(ffi.Pointer<ffi.Void>)
    _Model_get_modelStyle = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Model_get_modelStyle')
        .asFunction();
final void Function(
    ...
    _Model_set_modelStyle = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Model_set_modelStyle')
        .asFunction();
...
final void Function(
    ...
    _Model_setData = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Model_setData')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Model_set = lib.library
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_Model_set_')
    .asFunction(isLeaf: true);
