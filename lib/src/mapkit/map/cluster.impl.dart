...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _Cluster_get_placemarks = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Cluster_get_placemarks')
        .asFunction();
...
final core.int Function(ffi.Pointer<ffi.Void>) _Cluster_get_size = lib.library
    .lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_Cluster_get_size')
    .asFunction();
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _Cluster_get_appearance = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_Cluster_get_appearance')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Cluster_addClusterTapListener = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_Cluster_addClusterTapListener')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Cluster_removeClusterTapListener = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_Cluster_removeClusterTapListener')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Cluster_set = lib.library
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_Cluster_set_')
    .asFunction(isLeaf: true);
