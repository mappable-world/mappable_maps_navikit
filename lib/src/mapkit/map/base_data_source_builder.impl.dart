...
final _BaseDataSourceBuilder_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_BaseDataSourceBuilder_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _BaseDataSourceBuilder_check =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_BaseDataSourceBuilder_check')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_map_BaseDataSourceBuilder_setImageUrlProvider')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _BaseDataSourceBuilder_set = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_BaseDataSourceBuilder_set_')
        .asFunction(isLeaf: true);
