...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _MapObjectVisitorsetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapObjectVisitor_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_mapkit_map_MapObjectVisitor_new')
        .asFunction(isLeaf: true);

final _MapObjectVisitor_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapObjectVisitor_free');
