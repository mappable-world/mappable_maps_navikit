...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectTags_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_GeoObjectTags_downcast')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectTags_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_GeoObjectTags_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function() _GeoObjectTags_name = lib.library
    .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
        'mappable_flutter_mapkit_map_GeoObjectTags_name')
    .asFunction(isLeaf: true);

final _GeoObjectTags_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_map_GeoObjectTags_free');
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectTags_init = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_GeoObjectTags_init')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectTags_get_tags = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_GeoObjectTags_get_tags')
        .asFunction(isLeaf: true);
