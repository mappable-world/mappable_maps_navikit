...
final _PlacemarksStyler_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarksStyler_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _PlacemarksStyler_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarksStyler_check')
...
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _PlacemarksStyler_setScaleFunction = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarksStyler_setScaleFunction')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _PlacemarksStyler_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_map_PlacemarksStyler_set_')
    .asFunction(isLeaf: true);
