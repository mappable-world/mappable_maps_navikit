...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _MapObject_get_parent = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapObject_get_parent')
        .asFunction();

final core.bool Function(ffi.Pointer<ffi.Void>) _MapObject_get_visible = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapObject_get_visible')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.bool) _MapObject_set_visible =
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapObject_set_visible')
        .asFunction();
...
final core.double Function(ffi.Pointer<ffi.Void>) _MapObject_get_zIndex = lib
    ...
    .lookup<ffi.NativeFunction<ffi.Float Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapObject_get_zIndex')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.double) _MapObject_set_zIndex =
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapObject_set_zIndex')
        .asFunction();

final core.bool Function(ffi.Pointer<ffi.Void>) _MapObject_get_draggable = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapObject_get_draggable')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.bool) _MapObject_set_draggable =
    lib
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Bool)>>(
            'mappable_flutter_mapkit_map_MapObject_set_draggable')
        .asFunction();
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_MapObject_setVisible')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _MapObject_addTapListener = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapObject_addTapListener')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _MapObject_removeTapListener = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_MapObject_removeTapListener')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _MapObject_setDragListener = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_MapObject_setDragListener')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_MapObject_set_')
    .asFunction(isLeaf: true);
final core.Object? Function(ffi.Pointer<ffi.Void>) _MapObject_get_userData = lib
    ...
    .lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_MapObject_get_userData')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.Object?)
    _MapObject_set_userData = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_MapObject_set_userData')
        .asFunction();
