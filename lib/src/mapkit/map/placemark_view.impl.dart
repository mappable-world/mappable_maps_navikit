...
final _PlacemarkView_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkView_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _PlacemarkView_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkView_check')
...
final mapkit_map_icon_style.IconStyleNative Function(ffi.Pointer<ffi.Void>)
    _PlacemarkView_get_style = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkView_get_style')
        .asFunction();
final void Function(
    ...
    _PlacemarkView_set_style = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkView_set_style')
        .asFunction();
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        mapkit_map_icon_style.IconStyleNative)>>(
            'mappable_flutter_mapkit_map_PlacemarkView_setView')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_map_icon_style.IconStyleNative,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_map_PlacemarkView_setViewWithCallback')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _PlacemarkView_set = lib
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_PlacemarkView_set_')
    .asFunction(isLeaf: true);
