        ...
        .lookup<
                ffi.NativeFunction<
                    VisibleRegionNative Function(
                        ...
                        mapkit_geometry_point.PointNative,
                        mapkit_geometry_point.PointNative)>>(
            'mappable_flutter_mapkit_map_VisibleRegion_init')
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_geometry.GeometryNative Function(
                        VisibleRegionNative)>>(
            'mappable_flutter_mapkit_map_VisibleRegionUtils_toPolygon')
        .asFunction();
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_geometry.BoundingBoxNative Function(
                        VisibleRegionNative)>>(
            'mappable_flutter_mapkit_map_VisibleRegionUtils_getBounds')
        .asFunction();
