...
final _PlacemarkText_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkText_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _PlacemarkText_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_map_PlacemarkText_check')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _PlacemarkText_get_text = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkText_get_text')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeString)
    _PlacemarkText_set_text = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkText_set_text')
        .asFunction();
...
final mapkit_map_text_style.TextStyleNative Function(ffi.Pointer<ffi.Void>)
    _PlacemarkText_get_style = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkText_get_style')
        .asFunction();
final void Function(
    ...
    _PlacemarkText_set_style = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_map_PlacemarkText_set_style')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, core.int) _PlacemarkText_set = lib
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_map_PlacemarkText_set_')
    .asFunction(isLeaf: true);
