...
final _BaseDataSource_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_BaseDataSource_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _BaseDataSource_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_BaseDataSource_check')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _BaseDataSource_get_id = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_BaseDataSource_get_id')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, core.int) _BaseDataSource_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_layers_BaseDataSource_set_')
    .asFunction(isLeaf: true);
...
final _TileDataSource_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_TileDataSource_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _TileDataSource_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_TileDataSource_check')
    .asFunction(isLeaf: true);
...
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeString)
    _TileDataSource_invalidate = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_TileDataSource_invalidate')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _TileDataSource_set = lib
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_mapkit_layers_TileDataSource_set_')
    .asFunction(isLeaf: true);
...
final _DataSource_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_DataSource_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _DataSource_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_DataSource_check')
    .asFunction(isLeaf: true);
...
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeBytes)
    _DataSource_setData = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_DataSource_setData')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_layers_DataSource_set_')
    .asFunction(isLeaf: true);
...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _DataSourceListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_DataSourceListener_setSendPort')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _DataSourceListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_DataSourceListener_new')
        .asFunction(isLeaf: true);

final _DataSourceListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_DataSourceListener_free');
