...
final _ObjectEvent_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_ObjectEvent_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _ObjectEvent_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_ObjectEvent_check')
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_layers_ObjectEvent_set_')
    .asFunction(isLeaf: true);
