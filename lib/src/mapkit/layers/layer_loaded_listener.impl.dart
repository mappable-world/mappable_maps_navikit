...
final void Function(ffi.Pointer<ffi.Void>, core.int, core.int)
    _LayerLoadedListenersetSendPort = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_LayerLoadedListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _LayerLoadedListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_LayerLoadedListener_new')
        .asFunction(isLeaf: true);

final _LayerLoadedListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_LayerLoadedListener_free');
