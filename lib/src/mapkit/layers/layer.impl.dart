...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _Layer_dataSourceLayer = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_Layer_dataSourceLayer')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Layer_set = lib.library
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_layers_Layer_set_')
    .asFunction(isLeaf: true);
