...
final _GeoObjectTapEvent_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_GeoObjectTapEvent_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _GeoObjectTapEvent_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_GeoObjectTapEvent_check')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _GeoObjectTapEvent_get_geoObject = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_GeoObjectTapEvent_get_geoObject')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, core.int) _GeoObjectTapEvent_set =
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_GeoObjectTapEvent_set_')
        .asFunction(isLeaf: true);
