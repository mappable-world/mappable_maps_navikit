...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_layers_LayersGeoObjectTapListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _LayersGeoObjectTapListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_layers_LayersGeoObjectTapListener_new')
        .asFunction(isLeaf: true);

final _LayersGeoObjectTapListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_layers_LayersGeoObjectTapListener_free');
