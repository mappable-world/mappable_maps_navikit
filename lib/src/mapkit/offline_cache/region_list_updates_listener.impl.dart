...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_offline_cache_OfflineMapRegionListUpdatesListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _OfflineMapRegionListUpdatesListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_offline_cache_OfflineMapRegionListUpdatesListener_new')
        .asFunction(isLeaf: true);

final _OfflineMapRegionListUpdatesListener_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_mapkit_offline_cache_OfflineMapRegionListUpdatesListener_free');
