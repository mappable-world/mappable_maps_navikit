...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_offline_cache_OfflineCacheRegionListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _OfflineCacheRegionListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_offline_cache_OfflineCacheRegionListener_new')
        .asFunction(isLeaf: true);

final _OfflineCacheRegionListener_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_mapkit_offline_cache_OfflineCacheRegionListener_free');
