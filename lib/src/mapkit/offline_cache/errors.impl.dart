...
final _CachePathUnavailable_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_offline_cache_CachePathUnavailable_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _CachePathUnavailable_check =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_offline_cache_CachePathUnavailable_check')
...
final void Function(ffi.Pointer<ffi.Void>, core.int) _CachePathUnavailable_set =
    lib
        ...
        .lookup<
            ...
            'mappable_flutter_mapkit_offline_cache_CachePathUnavailable_set_')
        .asFunction(isLeaf: true);
