...
final _RequestPoint_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_mapkit_RequestPoint_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_RequestPoint_init')
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_point.PointNative Function(
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_RequestPoint_get_point')
        .asFunction(isLeaf: true);
final core.int Function(ffi.Pointer<ffi.Void>) _RequestPoint_get_type = lib
    ...
    .lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_RequestPoint_get_type')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _RequestPoint_get_pointContext = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_RequestPoint_get_pointContext')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _RequestPoint_get_drivingArrivalPointId = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_RequestPoint_get_drivingArrivalPointId')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _RequestPoint_get_indoorLevelId = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_mapkit_RequestPoint_get_indoorLevelId')
        .asFunction(isLeaf: true);
