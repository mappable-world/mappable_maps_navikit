...
final void Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_FlutterRoadEventsLayerFactory_setRoadEventsStyleProvider')
    .asFunction();
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_FlutterRoadEventsLayerFactory_createRouteRoadEventsLayerWithPresetStyleProvider')
        .asFunction();
