        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_geometry.BoundingBoxNative Function(
                        mapkit_geometry_geometry.BoundingBoxNative)>>(
            'mappable_flutter_mapkit_geometry_BoundingBoxHelper_getBounds')
        .asFunction();
final mapkit_geometry_geometry.BoundingBoxNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_geometry_BoundingBoxHelper_getBoundsFromPoint')
    .asFunction();
final mapkit_geometry_geometry.BoundingBoxNative Function(
    ffi
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_geometry_BoundingBoxHelper_getBoundsFromPolyline')
    .asFunction();
final mapkit_geometry_geometry.BoundingBoxNative Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                mapkit_geometry_geometry.BoundingBoxNative Function(
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_geometry_BoundingBoxHelper_getBoundsFromRing')
    .asFunction();
final mapkit_geometry_geometry.BoundingBoxNative Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                mapkit_geometry_geometry.BoundingBoxNative Function(
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_geometry_BoundingBoxHelper_getBoundsFromPolygon')
    .asFunction();
final mapkit_geometry_geometry.BoundingBoxNative Function(
    mapkit_geometry_geometry.BoundingBoxNative,
    ...
    .lookup<
            ffi.NativeFunction<
                mapkit_geometry_geometry.BoundingBoxNative Function(
                    mapkit_geometry_geometry.BoundingBoxNative,
                    mapkit_geometry_geometry.BoundingBoxNative)>>(
        'mappable_flutter_mapkit_geometry_BoundingBoxHelper_getBoundsFromTwoBoxes')
    .asFunction();
