...
class ProjectionImpl implements Projection, ffi.Finalizable {
  ...
  mapkit_geometry_geo_xy_point.XYPoint worldToXY(
    ...
    return mapkit_geometry_geo_xy_point.XYPointImpl.fromNative(
  ...
  mapkit_geometry_point.Point xyToWorld(
    ...
    return mapkit_geometry_point.PointImpl.fromNative(_Projection_xyToWorld(
...
final _Projection_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_geometry_geo_Projection_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _Projection_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_geometry_geo_Projection_check')
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_geo_xy_point.XYPointNative Function(
                        ...
                        ffi.Int)>>(
            'mappable_flutter_mapkit_geometry_geo_Projection_worldToXY')
        .asFunction();
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_point.PointNative Function(
                        ...
                        ffi.Int)>>(
            'mappable_flutter_mapkit_geometry_geo_Projection_xyToWorld')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Projection_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_geometry_geo_Projection_set_')
    .asFunction(isLeaf: true);
