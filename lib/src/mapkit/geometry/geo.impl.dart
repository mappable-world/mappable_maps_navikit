...
final core.double Function(
    ...
    _Geo_distance = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_geometry_Geo_distance')
        .asFunction();
final mapkit_geometry_point.PointNative Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_geometry_Geo_closestPoint')
        .asFunction();
final mapkit_geometry_point.PointNative Function(
    ...
    _Geo_pointOnSegmentByFactor = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_geometry_Geo_pointOnSegmentByFactor')
        .asFunction();
final core.double Function(
        mapkit_geometry_point.PointNative, mapkit_geometry_point.PointNative)
    _Geo_course = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Double Function(mapkit_geometry_point.PointNative,
                        mapkit_geometry_point.PointNative)>>(
            'mappable_flutter_mapkit_geometry_Geo_course')
        .asFunction();
