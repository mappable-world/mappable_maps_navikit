...
final _RoadEventsEventInfoSession_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_RoadEventsEventInfoSession_free');
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_RoadEventsEventInfoSession_retry')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _EventInfoSession_cancel = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_RoadEventsEventInfoSession_cancel')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
        .int) _RoadEventsEventInfoSession_set = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_mapkit_road_events_RoadEventsEventInfoSession_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_EventInfoSession_RoadEventsEventInfoSessionEventInfoListener_setSendPort')
    .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_mapkit_road_events_EventInfoSession_RoadEventsEventInfoSessionEventInfoListener_new')
        .asFunction(isLeaf: true);
...
final _RoadEventsManager_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_road_events_RoadEventsManager_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_road_events_RoadEventsManager_requestEventInfo')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _RoadEventsManager_set =
    lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
            'mappable_flutter_mapkit_road_events_RoadEventsManager_set_')
        .asFunction(isLeaf: true);
