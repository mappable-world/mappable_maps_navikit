...
final _PolylineStyle_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_styling_PolylineStyle_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _PolylineStyle_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_styling_PolylineStyle_check')
...
final void Function(ffi.Pointer<ffi.Void>,
    ...
    _PolylineStyle_setStrokeWidth = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_styling_PolylineStyle_setStrokeWidth')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>,
        mapkit_styling_proportion_function.StylingProportionFunctionNative)
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_styling_proportion_function
                            .StylingProportionFunctionNative)>>(
            'mappable_flutter_mapkit_styling_PolylineStyle_setOutlineWidth')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeColor)
    _PolylineStyle_setStrokeColor = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_styling_PolylineStyle_setStrokeColor')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeColor)
    _PolylineStyle_setOutlineColor = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, native_types.NativeColor)>>(
            'mappable_flutter_mapkit_styling_PolylineStyle_setOutlineColor')
        .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_styling_PolylineStyle_setInnerOutlineEnabled')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.double)
    _PolylineStyle_setTurnRadius = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_styling_PolylineStyle_setTurnRadius')
        .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Float)>>(
        'mappable_flutter_mapkit_styling_PolylineStyle_setArcApproximationStep')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.double)
    _PolylineStyle_setDashLength = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Float)>>(
            'mappable_flutter_mapkit_styling_PolylineStyle_setDashLength')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.double)
    _PolylineStyle_setGapLength = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Float)>>(
            'mappable_flutter_mapkit_styling_PolylineStyle_setGapLength')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.double)
    _PolylineStyle_setDashOffset = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Float)>>(
            'mappable_flutter_mapkit_styling_PolylineStyle_setDashOffset')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _PolylineStyle_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_mapkit_styling_PolylineStyle_set_')
    .asFunction(isLeaf: true);
