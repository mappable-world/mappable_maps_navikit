...
final _ArrowStyle_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_styling_ArrowStyle_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _ArrowStyle_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_mapkit_styling_ArrowStyle_check')
...
final void Function(ffi.Pointer<ffi.Void>,
    ...
    _ArrowStyle_setOutlineWidth = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_styling_ArrowStyle_setOutlineWidth')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>,
        mapkit_styling_proportion_function.StylingProportionFunctionNative)
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_styling_proportion_function
                            .StylingProportionFunctionNative)>>(
            'mappable_flutter_mapkit_styling_ArrowStyle_setLength')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>,
        mapkit_styling_proportion_function.StylingProportionFunctionNative)
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        mapkit_styling_proportion_function
                            .StylingProportionFunctionNative)>>(
            'mappable_flutter_mapkit_styling_ArrowStyle_setTriangleHeight')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeColor)
    _ArrowStyle_setFillColor = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_styling_ArrowStyle_setFillColor')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativeColor)
    _ArrowStyle_setOutlineColor = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, native_types.NativeColor)>>(
            'mappable_flutter_mapkit_styling_ArrowStyle_setOutlineColor')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _ArrowStyle_setMinZoomVisible = lib.library
        .lookup<
            ...
            'mappable_flutter_mapkit_styling_ArrowStyle_setMinZoomVisible')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_mapkit_styling_ArrowStyle_set_')
    .asFunction(isLeaf: true);
