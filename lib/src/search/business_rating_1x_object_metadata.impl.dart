...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_downcast')
    .asFunction(isLeaf: true);

final ffi.Pointer<ffi.Void> Function(
    ffi
        .Pointer<ffi.Void>) _SearchBusinessRating1xObjectMetadata_upcast = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_upcast')
    .asFunction(isLeaf: true);

final native_types.NativeString Function()
    _SearchBusinessRating1xObjectMetadata_name = lib.library
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_name')
        .asFunction(isLeaf: true);

final _SearchBusinessRating1xObjectMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(core.int, core.int, ffi.Pointer<ffi.Void>)
    _SearchBusinessRating1xObjectMetadata_init = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_init')
        .asFunction(isLeaf: true);
...
final core.int Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_get_ratings')
    .asFunction(isLeaf: true);
final core.int Function(
    ffi.Pointer<
    ...
    .library
    .lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_get_reviews')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi.Pointer<
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchBusinessRating1xObjectMetadata_get_score')
    .asFunction(isLeaf: true);
