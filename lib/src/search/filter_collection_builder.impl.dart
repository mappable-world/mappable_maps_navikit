...
final _SearchFilterCollectionBuilder_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchFilterCollectionBuilder_free');
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_SearchFilterCollectionBuilder_addBooleanFilter')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    native_types.NativeString,
    ffi
        .Pointer<ffi.Void>) _FilterCollectionBuilder_addEnumFilter = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>,
                    native_types.NativeString, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchFilterCollectionBuilder_addEnumFilter')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    native_types.NativeString,
    ...
    .lookup<
        ...
        'mappable_flutter_search_SearchFilterCollectionBuilder_addRangeFilter')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    native_types.NativeString,
    native_types.NativeString,
    native_types
        .NativeString) _FilterCollectionBuilder_addDateFilter = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>,
                    ...
                    native_types.NativeString,
                    native_types.NativeString)>>(
        'mappable_flutter_search_SearchFilterCollectionBuilder_addDateFilter')
    .asFunction();
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _FilterCollectionBuilder_build = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchFilterCollectionBuilder_build')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _SearchFilterCollectionBuilder_set = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchFilterCollectionBuilder_set_')
...
final ffi.Pointer<ffi.Void> Function()
    _FilterCollectionUtils_createFilterCollectionBuilder = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
            'mappable_flutter_search_SearchFilterCollectionUtils_createFilterCollectionBuilder')
        .asFunction();
