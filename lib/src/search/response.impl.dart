...
final _SearchResponse_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchResponse_free');

final ffi.Pointer<ffi.Void> Function(
        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, core.bool)
    _SearchResponse_init = lib.library
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<ffi.Void>,
                    ffi.Pointer<ffi.Void>,
                    ffi.Bool)>>('mappable_flutter_search_SearchResponse_init')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchResponse_get_metadata = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchResponse_get_metadata')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchResponse_get_collection = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchResponse_get_collection')
        .asFunction(isLeaf: true);
final core.bool Function(ffi.Pointer<ffi.Void>) _SearchResponse_get_isOffline =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchResponse_get_isOffline')
        .asFunction(isLeaf: true);
