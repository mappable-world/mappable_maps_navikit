...
final _SearchSuggestSession_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchSuggestSession_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        search_suggest_options.SuggestOptionsNative,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchSuggestSession_suggest')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _SuggestSession_reset = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchSuggestSession_reset')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _SearchSuggestSession_set =
    lib
        ...
        .lookup<
            ...
            'mappable_flutter_search_SearchSuggestSession_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_SuggestSession_SearchSuggestSessionSuggestListener_setSendPort')
    .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>,
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_search_SuggestSession_SearchSuggestSessionSuggestListener_new')
        .asFunction(isLeaf: true);
