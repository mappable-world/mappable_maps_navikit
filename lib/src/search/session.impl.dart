...
final _SearchSession_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchSession_free');

final void Function(ffi.Pointer<ffi.Void>) _Session_cancel = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchSession_cancel')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Session_retry = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchSession_retry')
        .asFunction();
final core.bool Function(ffi.Pointer<ffi.Void>) _Session_hasNextPage = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchSession_hasNextPage')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Session_fetchNextPage = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchSession_fetchNextPage')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Session_setFilters = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchSession_setFilters')
        .asFunction();
final void Function(
    ...
    _Session_setSortByDistance = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchSession_setSortByDistance')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _Session_resetSort = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchSession_resetSort')
    .asFunction();
final void Function(
        ffi.Pointer<ffi.Void>, mapkit_geometry_geometry.GeometryNative)
    _Session_setSearchArea = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>,
                        mapkit_geometry_geometry.GeometryNative)>>(
            'mappable_flutter_search_SearchSession_setSearchArea')
        .asFunction();
final void Function(
    ...
    _Session_setSearchOptions = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchSession_setSearchOptions')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Session_resubmit = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchSession_resubmit')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _SearchSession_set = lib
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_search_SearchSession_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_Session_SearchSessionSearchListener_setSendPort')
    .asFunction(isLeaf: true);
