...
final _SearchDeleteAllPersonalSuggestSession_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchDeleteAllPersonalSuggestSession_free');
...
final void Function(
    ...
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchDeleteAllPersonalSuggestSession_cancel')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _DeleteAllPersonalSuggestSession_retry = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchDeleteAllPersonalSuggestSession_retry')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
        .int) _SearchDeleteAllPersonalSuggestSession_set = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_search_SearchDeleteAllPersonalSuggestSession_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_DeleteAllPersonalSuggestSession_PersonalSuggestListener_setSendPort')
    .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_search_DeleteAllPersonalSuggestSession_PersonalSuggestListener_new')
        .asFunction(isLeaf: true);
