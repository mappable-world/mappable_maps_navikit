...
final _SearchCacheUnavailableError_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchCacheUnavailableError_free');
final core.bool Function(ffi.Pointer<ffi.Void>)
    _SearchCacheUnavailableError_check = lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchCacheUnavailableError_check')
...
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _SearchCacheUnavailableError_set = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchCacheUnavailableError_set_')
        .asFunction(isLeaf: true);
