...
final _SearchReferenceType_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchReferenceType_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        native_types.NativeString, native_types.NativeString)>>(
            'mappable_flutter_search_SearchReferenceType_init')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _SearchReferenceType_get_id = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchReferenceType_get_id')
        .asFunction(isLeaf: true);
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _SearchReferenceType_get_scope = lib.library
        .lookup<
                ffi.NativeFunction<
                    native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchReferenceType_get_scope')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchReferencesObjectMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchReferencesObjectMetadata_downcast')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchReferencesObjectMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchReferencesObjectMetadata_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function()
    _SearchReferencesObjectMetadata_name = lib.library
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_search_SearchReferencesObjectMetadata_name')
        .asFunction(isLeaf: true);

final _SearchReferencesObjectMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchReferencesObjectMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchReferencesObjectMetadata_init = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchReferencesObjectMetadata_init')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchReferencesObjectMetadata_get_references')
    .asFunction(isLeaf: true);
