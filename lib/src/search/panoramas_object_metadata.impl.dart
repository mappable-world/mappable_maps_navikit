    ...
    .lookup<
        ffi.NativeFunction<
            SearchPanoramaNative Function(
              ...
              mapkit_geometry_span.SpanNative,
              mapkit_geometry_point.PointNative,
            )>>('mappable_flutter_search_SearchPanorama_init')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchPanoramasObjectMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchPanoramasObjectMetadata_downcast')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchPanoramasObjectMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchPanoramasObjectMetadata_upcast')
        .asFunction(isLeaf: true);
...
final native_types.NativeString Function() _SearchPanoramasObjectMetadata_name =
    lib
        ...
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_search_SearchPanoramasObjectMetadata_name')
        .asFunction(isLeaf: true);

final _SearchPanoramasObjectMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchPanoramasObjectMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchPanoramasObjectMetadata_init = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchPanoramasObjectMetadata_init')
        .asFunction(isLeaf: true);

final ffi.Pointer<ffi.Void> Function(
    ffi
        .Pointer<ffi.Void>) _SearchPanoramasObjectMetadata_get_panoramas = lib
    .library
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchPanoramasObjectMetadata_get_panoramas')
    .asFunction(isLeaf: true);
