...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchToponymResultMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchToponymResultMetadata_downcast')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchToponymResultMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchToponymResultMetadata_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function() _SearchToponymResultMetadata_name =
    lib.library
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_search_SearchToponymResultMetadata_name')
        .asFunction(isLeaf: true);

final _SearchToponymResultMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchToponymResultMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _SearchToponymResultMetadata_init = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchToponymResultMetadata_init')
        .asFunction(isLeaf: true);
...
final core.int Function(ffi.Pointer<ffi.Void>)
    _SearchToponymResultMetadata_get_found = lib.library
        .lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchToponymResultMetadata_get_found')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchToponymResultMetadata_get_responseInfo')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchToponymResultMetadata_get_reversePoint')
    .asFunction(isLeaf: true);
...
final SearchToponymResultMetadataResponseInfoNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_ToponymResultMetadata_SearchToponymResultMetadataResponseInfo_init')
    .asFunction(isLeaf: true);
