...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchOrgOwnershipObjectMetadata_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchOrgOwnershipObjectMetadata_downcast')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchOrgOwnershipObjectMetadata_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchOrgOwnershipObjectMetadata_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function()
    _SearchOrgOwnershipObjectMetadata_name = lib.library
        .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
            'mappable_flutter_search_SearchOrgOwnershipObjectMetadata_name')
        .asFunction(isLeaf: true);

final _SearchOrgOwnershipObjectMetadata_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchOrgOwnershipObjectMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchOrgOwnershipObjectMetadata_init = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchOrgOwnershipObjectMetadata_init')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_SearchOrgOwnershipObjectMetadata_get_canBeClaimed')
    .asFunction(isLeaf: true);
