...
final _SearchCategory_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_search_SearchCategory_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _SearchCategory_init = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchCategory_init')
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _SearchCategory_get_name = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchCategory_get_name')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchCategory_get_categoryClass = lib.library
        .lookup<
            ...
            'mappable_flutter_search_SearchCategory_get_categoryClass')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchCategory_get_tags = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_SearchCategory_get_tags')
        .asFunction(isLeaf: true);
