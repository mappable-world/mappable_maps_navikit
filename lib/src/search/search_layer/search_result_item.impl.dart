...
final _SearchResultItem_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_search_layer_SearchResultItem_free');
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _SearchResultItem_get_id = lib.library
        .lookup<
            ...
            'mappable_flutter_search_search_layer_SearchResultItem_get_id')
        .asFunction();
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _SearchResultItem_get_name = lib.library
        .lookup<
                ffi.NativeFunction<
                    native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_search_layer_SearchResultItem_get_name')
        .asFunction();
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_search_layer_SearchResultItem_get_categoryClass')
    .asFunction();

final ffi.Pointer<ffi.Void> Function(
    ffi
        .Pointer<ffi.Void>) _SearchResultItem_get_geoObject = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_search_layer_SearchResultItem_get_geoObject')
    .asFunction();
...
final mapkit_geometry_point.PointNative Function(ffi.Pointer<ffi.Void>)
    _SearchResultItem_get_point = lib.library
        .lookup<
            ...
            'mappable_flutter_search_search_layer_SearchResultItem_get_point')
        .asFunction();

final core.bool Function(ffi.Pointer<ffi.Void>) _SearchResultItem_hasDetails =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_search_layer_SearchResultItem_hasDetails')
        .asFunction();
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _SearchResultItem_details = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_search_layer_SearchResultItem_details')
        .asFunction();
final core.bool Function(
    ffi
        .Pointer<ffi.Void>) _SearchResultItem_isCollection = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_search_layer_SearchResultItem_isCollection')
    .asFunction();
final core.bool Function(ffi.Pointer<ffi.Void>) _SearchResultItem_isClosed = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_search_layer_SearchResultItem_isClosed')
    .asFunction();
final core.bool Function(ffi.Pointer<ffi.Void>) _SearchResultItem_isOffline =
    lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_search_search_layer_SearchResultItem_isOffline')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _SearchResultItem_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_search_search_layer_SearchResultItem_set_')
