...
final SizeNative Function(core.double, core.double) _SizeNativeInit = lib
    ...
    .lookup<ffi.NativeFunction<SizeNative Function(ffi.Double, ffi.Double)>>(
        'mappable_flutter_search_search_layer_Size_init')
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64,
                        ffi.Int64, ffi.Int64)>>(
            'mappable_flutter_search_search_layer_AssetsProvider_setSendPort')
        .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_search_search_layer_AssetsProvider_new')
        .asFunction(isLeaf: true);

final _AssetsProvider_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_search_search_layer_AssetsProvider_free');
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_search_search_layer_AssetsProvider_image_invokeOnResult')
    .asFunction(isLeaf: true);
