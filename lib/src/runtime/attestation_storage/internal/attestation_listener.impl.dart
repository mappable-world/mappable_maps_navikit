...
final _AttestationListener_free = lib.library.lookup<
    ...
    'mappable_flutter_runtime_attestation_storage_internal_AttestationListener_free');
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_runtime_attestation_storage_internal_AttestationListener_onAttestationReceived')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    native_types
    ...
    .lookup<
        ...
        'mappable_flutter_runtime_attestation_storage_internal_AttestationListener_onAttestationFailed')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
        ...
        'mappable_flutter_runtime_attestation_storage_internal_AttestationListener_set_')
