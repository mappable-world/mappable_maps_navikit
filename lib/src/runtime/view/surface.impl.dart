...
final _Surface_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_runtime_view_Surface_free');
...
final native_types.NativePoint Function(ffi.Pointer<ffi.Void>)
    _Surface_get_anchorPoint = lib.library
        .lookup<
            ...
            'mappable_flutter_runtime_view_Surface_get_anchorPoint')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, native_types.NativePoint)
    _Surface_set_anchorPoint = lib.library
        .lookup<
            ...
            'mappable_flutter_runtime_view_Surface_set_anchorPoint')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_runtime_view_Surface_set_')
