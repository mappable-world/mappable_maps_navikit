...
final void Function(core.int) _Runtime_onDetachedFromEngine = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int)>>(
        'mappable_flutter_runtime_Runtime_onDetachedFromEngine')
    .asFunction();
