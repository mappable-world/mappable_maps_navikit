...
final _EcPublicKey_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_runtime_attestation_EcPublicKey_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_runtime_attestation_EcPublicKey_init')
...
final native_types.NativeBytes Function(ffi.Pointer<ffi.Void>)
    _EcPublicKey_get_affineX = lib.library
        .lookup<
            ...
            'mappable_flutter_runtime_attestation_EcPublicKey_get_affineX')
        .asFunction(isLeaf: true);
final native_types.NativeBytes Function(ffi.Pointer<ffi.Void>)
    _EcPublicKey_get_affineY = lib.library
        .lookup<
                ffi.NativeFunction<
                    native_types.NativeBytes Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_runtime_attestation_EcPublicKey_get_affineY')
        .asFunction(isLeaf: true);
