...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_guidance_camera_CameraListener_setSendPort')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _CameraListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_guidance_camera_CameraListener_new')
        .asFunction(isLeaf: true);

final _CameraListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_CameraListener_free');
...
final _Camera_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _Camera_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_check')
    .asFunction(isLeaf: true);
...
final core.bool Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_get_switchModesAutomatically')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_guidance_camera_Camera_set_switchModesAutomatically')
    .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Camera_addListener = lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_guidance_camera_Camera_addListener')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Camera_removeListener = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_navigation_guidance_camera_Camera_removeListener')
        .asFunction();
    ...
    _Camera_setAutoZoom = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Bool,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_navigation_guidance_camera_Camera_setAutoZoom')
        .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core.bool,
    ffi
        .Pointer<ffi.Void>) _Camera_setAutoRotation = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Bool, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_setAutoRotation')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core.double,
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_guidance_camera_Camera_setFollowingModeZoomOffset')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _Camera_setOverviewRect = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_setOverviewRect')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_setExtraOverviewPoints')
    .asFunction();
final core.int Function(ffi.Pointer<ffi.Void>) _Camera_cameraMode = lib.library
    .lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_cameraMode')
    .asFunction();
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_navigation_guidance_camera_Camera_setCameraMode')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _Camera_set = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_navigation_guidance_camera_Camera_set_')
    .asFunction(isLeaf: true);
