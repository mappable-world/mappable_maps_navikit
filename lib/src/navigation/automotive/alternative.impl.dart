...
final _NavigationAlternative_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_NavigationAlternative_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_NavigationAlternative_get_alternative')
    .asFunction();
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_NavigationAlternative_get_forkPositionOnAlternative')
    .asFunction();
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_NavigationAlternative_get_forkPositionOnCurrentRoute')
    .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, core.int)
    _NavigationAlternative_set = lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_automotive_NavigationAlternative_set_')
