        ...
        .lookup<
                ffi.NativeFunction<
                    SpeedLimitsNative Function(
                        ...
                        mapkit_localized_value.LocalizedValueNative,
                        mapkit_localized_value.LocalizedValueNative)>>(
            'mappable_flutter_navigation_automotive_SpeedLimits_init')
...
final SpeedLimitsRulesNative Function(core.int, core.int, core.int)
    _SpeedLimitsRulesNativeInit = lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_automotive_SpeedLimitsRules_init')
        .asFunction(isLeaf: true);
...
final _SpeedLimitsPolicy_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_SpeedLimitsPolicy_free');
...
final SpeedLimitsNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedLimitsPolicy_get_legalSpeedLimits')
    .asFunction();
...
final SpeedLimitsRulesNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedLimitsPolicy_get_speedLimitsRules')
    .asFunction();
...
final SpeedLimitsNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedLimitsPolicy_customSpeedLimits')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _SpeedLimitsPolicy_set =
    lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_automotive_SpeedLimitsPolicy_set_')
        .asFunction(isLeaf: true);
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedPolicyListener_setSendPort')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _SpeedPolicyListener_new = lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_automotive_SpeedPolicyListener_new')
        .asFunction(isLeaf: true);

final _SpeedPolicyListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_SpeedPolicyListener_free');
...
final _SpeedPolicyProvider_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_SpeedPolicyProvider_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedPolicyProvider_get_speedLimitsPolicy')
    .asFunction();
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedPolicyProvider_addListener')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_SpeedPolicyProvider_removeListener')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_SpeedPolicyProvider_updateSpeedLimitsPolicy')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _SpeedPolicyProvider_set =
    lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
            'mappable_flutter_navigation_automotive_SpeedPolicyProvider_set_')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function()
    _SpeedPolicyProviderFactory_getSpeedPolicyProvider = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
            'mappable_flutter_navigation_automotive_SpeedPolicyProviderFactory_getSpeedPolicyProvider')
        .asFunction();
