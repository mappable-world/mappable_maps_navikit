...
final _RouteView_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_layer_RouteView_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _RouteView_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_layer_RouteView_check')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _RouteView_get_route = lib.library
        .lookup<
            ...
            'mappable_flutter_navigation_automotive_layer_RouteView_get_route')
        .asFunction();
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_layer_RouteView_get_balloonViews')
    .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, core.int) _RouteView_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_RouteView_set_')
    .asFunction(isLeaf: true);
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_RouteViewListener_setSendPort')
    .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_navigation_automotive_layer_RouteViewListener_new')
        .asFunction(isLeaf: true);

final _RouteViewListener_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_layer_RouteViewListener_free');
