...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_BalloonViewListener_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_navigation_automotive_layer_BalloonViewListener_new')
        .asFunction(isLeaf: true);

final _BalloonViewListener_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_navigation_automotive_layer_BalloonViewListener_free');
