...
final SpeedControlHighlightStyleNative Function(
  ...
  native_types.NativePoint,
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_styling_SpeedControlHighlightStyle_init')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_styling_HighlightStyleProvider_setSendPort')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_styling_HighlightStyleProvider_new')
    .asFunction(isLeaf: true);

final void Function(ffi.Pointer<ffi.Void>) _HighlightStyleProvider_free = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_layer_styling_HighlightStyleProvider_free')
    .asFunction(isLeaf: true);
final core.bool Function(
    ffi
        .Pointer<ffi.Void>) _HighlightStyleProvider_exists = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_layer_styling_HighlightStyleProvider_exists')
    .asFunction(isLeaf: true);
