...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_layer_RequestPointListener_setSendPort')
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Uint32)>>)>>('mappable_flutter_navigation_automotive_layer_RequestPointListener_new')
        .asFunction(isLeaf: true);

final _RequestPointListener_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_navigation_automotive_layer_RequestPointListener_free');
