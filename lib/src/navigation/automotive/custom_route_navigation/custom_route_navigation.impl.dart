...
final _CustomRouteNavigation_free = lib.library.lookup<
    ...
    'mappable_flutter_navigation_automotive_custom_route_navigation_CustomRouteNavigation_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_custom_route_navigation_CustomRouteNavigation_get_navigation')
    .asFunction();
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_custom_route_navigation_CustomRouteNavigation_createCamera')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_custom_route_navigation_CustomRouteNavigation_startGuidance')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_custom_route_navigation_CustomRouteNavigation_set_')
...
final ffi.Pointer<ffi.Void> Function()
    _CustomRouteNavigationFactory_createNavigation = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
            'mappable_flutter_navigation_automotive_custom_route_navigation_CustomRouteNavigationFactory_createNavigation')
        .asFunction();
