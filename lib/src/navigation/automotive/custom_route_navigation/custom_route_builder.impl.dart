...
final NavigationCustomRouteOptionsNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_custom_route_navigation_NavigationCustomRouteOptions_init')
...
final _NavigationCustomRouteBuilder_free = lib.library.lookup<
    ...
    'mappable_flutter_navigation_automotive_custom_route_navigation_NavigationCustomRouteBuilder_free');
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    NavigationCustomRouteOptionsNative,
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_navigation_automotive_custom_route_navigation_NavigationCustomRouteBuilder_requestRoute')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
        ...
        'mappable_flutter_navigation_automotive_custom_route_navigation_NavigationCustomRouteBuilder_set_')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function()
    _CustomRouteBuilderFactory_createCustomRouteBuilder = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
            'mappable_flutter_navigation_automotive_custom_route_navigation_NavigationCustomRouteBuilderFactory_createCustomRouteBuilder')
        .asFunction();
