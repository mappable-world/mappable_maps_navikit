...
final _MrcPhotoPlayer_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_mrc_MrcPhotoPlayer_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _MrcPhotoPlayer_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_mrc_MrcPhotoPlayer_check')
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_places_mrc_MrcPhotoPlayer_set_')
    .asFunction(isLeaf: true);
