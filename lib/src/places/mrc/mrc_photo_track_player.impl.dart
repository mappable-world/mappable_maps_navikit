...
final _MrcPhotoTrackPlayer_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_mrc_MrcPhotoTrackPlayer_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _MrcPhotoTrackPlayer_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_mrc_MrcPhotoTrackPlayer_check')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _MrcPhotoTrackPlayer_get_photoId = lib.library
        .lookup<
            ...
            'mappable_flutter_places_mrc_MrcPhotoTrackPlayer_get_photoId')
        .asFunction();
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _MrcPhotoTrackPlayer_get_position = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_places_mrc_MrcPhotoTrackPlayer_get_position')
        .asFunction();

final core.bool Function(ffi.Pointer<ffi.Void>)
    _MrcPhotoTrackPlayer_get_isPlaying = lib.library
        .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_places_mrc_MrcPhotoTrackPlayer_get_isPlaying')
        .asFunction();
...
final void Function(ffi.Pointer<ffi.Void>, core.int) _MrcPhotoTrackPlayer_set =
    lib.library
        .lookup<
            ...
            'mappable_flutter_places_mrc_MrcPhotoTrackPlayer_set_')
        .asFunction(isLeaf: true);
