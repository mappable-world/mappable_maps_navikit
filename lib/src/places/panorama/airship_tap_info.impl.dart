...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _AirshipTapInfo_downcast = lib.library
        .lookup<
            ...
            'mappable_flutter_places_panorama_AirshipTapInfo_downcast')
...
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _AirshipTapInfo_upcast = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_places_panorama_AirshipTapInfo_upcast')
        .asFunction(isLeaf: true);

final native_types.NativeString Function() _AirshipTapInfo_name = lib.library
    .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
        'mappable_flutter_places_panorama_AirshipTapInfo_name')
    .asFunction(isLeaf: true);

final _AirshipTapInfo_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_places_panorama_AirshipTapInfo_free');
...
final ffi.Pointer<ffi.Void> Function(native_types.NativeString)
    _AirshipTapInfo_init = lib.library
        .lookup<
            ...
            'mappable_flutter_places_panorama_AirshipTapInfo_init')
        .asFunction(isLeaf: true);
...
final native_types.NativeString Function(ffi.Pointer<ffi.Void>)
    _AirshipTapInfo_get_panoramaId = lib.library
        .lookup<
            ...
            'mappable_flutter_places_panorama_AirshipTapInfo_get_panoramaId')
        .asFunction(isLeaf: true);
