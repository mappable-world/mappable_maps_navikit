...
final _PanoramaService_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_panorama_PanoramaService_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_places_panorama_PanoramaService_findNearest')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _PanoramaService_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_places_panorama_PanoramaService_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_places_panorama_PanoramaService_PanoramaServiceSearchListener_setSendPort')
    .asFunction(isLeaf: true);
        ...
        .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>)>>('mappable_flutter_places_panorama_PanoramaService_PanoramaServiceSearchListener_new')
        .asFunction(isLeaf: true);
...
final _PanoramaServiceSearchSession_free = lib.library.lookup<
    ...
    'mappable_flutter_places_panorama_PanoramaService_PanoramaServiceSearchSession_free');
...
final void Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_panorama_PanoramaService_PanoramaServiceSearchSession_retry')
    .asFunction();
final void Function(
    ffi
        .Pointer<ffi.Void>) _PanoramaService_SearchSession_cancel = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_panorama_PanoramaService_PanoramaServiceSearchSession_cancel')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_places_panorama_PanoramaService_PanoramaServiceSearchSession_set_')
    .asFunction(isLeaf: true);
