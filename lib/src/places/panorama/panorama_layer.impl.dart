...
final _PanoramaLayer_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_panorama_PanoramaLayer_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _PanoramaLayer_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_places_panorama_PanoramaLayer_check')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_places_panorama_PanoramaLayer_setStreetPanoramaVisible')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Bool)>>(
        'mappable_flutter_places_panorama_PanoramaLayer_setAirshipPanoramaVisible')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _PanoramaLayer_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_places_panorama_PanoramaLayer_set_')
    .asFunction(isLeaf: true);
