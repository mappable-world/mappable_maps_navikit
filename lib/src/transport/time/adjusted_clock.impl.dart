...
final _AdjustedClock_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_time_AdjustedClock_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _AdjustedClock_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_time_AdjustedClock_check')
...
final native_types.NativeAbsTimestamp Function(ffi.Pointer<ffi.Void>)
    _AdjustedClock_now = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_time_AdjustedClock_now')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _AdjustedClock_resume = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_time_AdjustedClock_resume')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>) _AdjustedClock_pause = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_time_AdjustedClock_pause')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _AdjustedClock_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_transport_time_AdjustedClock_set_')
    .asFunction(isLeaf: true);
