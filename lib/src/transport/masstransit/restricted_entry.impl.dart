...
final _MasstransitRestrictedEntry_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
    'mappable_flutter_transport_masstransit_MasstransitRestrictedEntry_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Uint32)>>(
        'mappable_flutter_transport_masstransit_MasstransitRestrictedEntry_init')
...
final core.int Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitRestrictedEntry_get_position')
    .asFunction(isLeaf: true);
...
final _RestrictedEntriesContainer_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
    'mappable_flutter_transport_masstransit_RestrictedEntriesContainer_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_RestrictedEntriesContainer_init')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_RestrictedEntriesContainer_get_entries')
    .asFunction(isLeaf: true);
