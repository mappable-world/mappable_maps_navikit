...
final TimeOptionsNative Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _TimeOptionsNativeInit = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_masstransit_TimeOptions_init')
...
final FitnessOptionsNative Function(core.bool) _FitnessOptionsNativeInit = lib
    ...
    .lookup<ffi.NativeFunction<FitnessOptionsNative Function(ffi.Bool)>>(
        'mappable_flutter_transport_masstransit_FitnessOptions_init')
    .asFunction(isLeaf: true);
...
final RouteOptionsNative Function(FitnessOptionsNative)
    _RouteOptionsNativeInit = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_masstransit_RouteOptions_init')
        .asFunction(isLeaf: true);
