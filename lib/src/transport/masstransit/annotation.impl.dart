        ...
        .lookup<
                ffi.NativeFunction<
                    MasstransitToponymNative Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_masstransit_MasstransitToponym_init')
...
final _MasstransitAnnotation_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_masstransit_MasstransitAnnotation_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_masstransit_MasstransitAnnotation_init')
        .asFunction(isLeaf: true);
    ...
    .lookup<
            ffi.NativeFunction<
                mapkit_geometry_geometry.PolylinePositionNative Function(
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitAnnotation_get_position')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitAnnotation_get_action')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitAnnotation_get_landmark')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitAnnotation_get_toponym')
    .asFunction(isLeaf: true);
