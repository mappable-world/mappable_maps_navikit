...
final _MasstransitRouteSerializer_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_transport_masstransit_MasstransitRouteSerializer_free');
...
final native_types.NativeBytes Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitRouteSerializer_save')
    .asFunction();
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitRouteSerializer_load')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitRouteSerializer_set_')
