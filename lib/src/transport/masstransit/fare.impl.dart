...
final MasstransitPaymentMediaNative Function(
  ...
  core.int,
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitPaymentMedia_init')
...
final MasstransitPaymentNative Function(
  ...
  mapkit_money.TaxiMoneyNative,
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitPayment_init')
    .asFunction(isLeaf: true);
    ...
    .lookup<
            ffi.NativeFunction<
                MasstransitSectionPaymentOptionNative Function(
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSectionPaymentOption_init')
    .asFunction(isLeaf: true);
...
final _MasstransitRoutePaymentOption_free = lib.library.lookup<
    ...
    'mappable_flutter_transport_masstransit_MasstransitRoutePaymentOption_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitRoutePaymentOption_init')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitRoutePaymentOption_get_payment')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitRoutePaymentOption_get_totalPrice')
    .asFunction(isLeaf: true);
