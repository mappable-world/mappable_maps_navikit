...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_downcast')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_upcast')
    .asFunction(isLeaf: true);

final native_types.NativeString Function() _VehicleRawData_name = lib.library
    .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_name')
    .asFunction(isLeaf: true);

final _VehicleRawData_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_free');

final ffi.Pointer<ffi.Void> Function(
    native_types.NativeString,
    native_types.NativeString,
    ffi
        .Pointer<ffi.Void>) _VehicleRawData_init = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(native_types.NativeString,
                    native_types.NativeString, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_init')
    .asFunction(isLeaf: true);
...
final native_types.NativeString Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_get_id')
    .asFunction(isLeaf: true);
final native_types.NativeString Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                native_types.NativeString Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_get_threadId')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_VehicleRawData_get_line')
    .asFunction(isLeaf: true);
