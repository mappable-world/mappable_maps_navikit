...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_downcast')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_upcast')
    .asFunction(isLeaf: true);

final native_types.NativeString Function() _SectionMetadataInternal_name = lib
    .library
    .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
        'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_name')
    .asFunction(isLeaf: true);

final _SectionMetadataInternal_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
    'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_init')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_get_metadata')
    .asFunction(isLeaf: true);
final core.bool Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_SectionMetadataInternal_get_isPassThroughTransportSection')
    .asFunction(isLeaf: true);
