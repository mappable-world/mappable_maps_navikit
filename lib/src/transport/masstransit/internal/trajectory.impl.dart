...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_downcast')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_upcast')
    .asFunction(isLeaf: true);

final native_types.NativeString Function() _TrajectorySegmentMetadata_name = lib
    .library
    .lookup<ffi.NativeFunction<native_types.NativeString Function()>>(
        'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_name')
    .asFunction(isLeaf: true);

final _TrajectorySegmentMetadata_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
    'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_init')
    .asFunction(isLeaf: true);
...
final core.int Function(
    ...
    .lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_get_time')
    .asFunction(isLeaf: true);
final core.int Function(
    ffi
    ...
    .lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_internal_TrajectorySegmentMetadata_get_duration')
    .asFunction(isLeaf: true);
