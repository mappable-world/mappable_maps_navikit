...
final _MasstransitSummary_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_masstransit_MasstransitSummary_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_masstransit_MasstransitSummary_init')
    ...
    .lookup<
            ffi.NativeFunction<
                transport_masstransit_weight.MasstransitWeightNative Function(
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSummary_get_weight')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitSummary_get_estimation')
    .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
        .Pointer<ffi.Void>) _MasstransitSummary_get_flags = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSummary_get_flags')
    .asFunction(isLeaf: true);
