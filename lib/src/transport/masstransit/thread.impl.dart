...
final _MasstransitThreadStop_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_masstransit_MasstransitThreadStop_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _MasstransitThreadStop_init = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_masstransit_MasstransitThreadStop_init')
...
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitThreadStop_get_stop')
    .asFunction(isLeaf: true);
final mapkit_geometry_point.PointNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_MasstransitThreadStop_get_position')
    .asFunction(isLeaf: true);
