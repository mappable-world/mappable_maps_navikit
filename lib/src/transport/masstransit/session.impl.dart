...
final _MasstransitSession_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSession_free');

final void Function(ffi.Pointer<ffi.Void>) _Session_cancel = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSession_cancel')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _Session_retry = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_masstransit_MasstransitSession_retry')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _MasstransitSession_set =
    lib.library
        .lookup<
            ...
            'mappable_flutter_transport_masstransit_MasstransitSession_set_')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_masstransit_Session_RouteHandler_setSendPort')
    .asFunction(isLeaf: true);
...
final _MasstransitSummarySession_free = lib.library.lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
    'mappable_flutter_transport_masstransit_MasstransitSummarySession_free');

final void Function(ffi.Pointer<ffi.Void>) _SummarySession_cancel = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSummarySession_cancel')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    ffi
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_masstransit_MasstransitSummarySession_retry')
    .asFunction();
final void Function(
    ffi.Pointer<ffi.Void>,
    core
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_transport_masstransit_MasstransitSummarySession_set_')
    .asFunction(isLeaf: true);
...
final void Function(
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<ffi.Void>, ffi.Int64, ffi.Int64)>>(
        'mappable_flutter_transport_masstransit_SummarySession_SummaryHandler_setSendPort')
    .asFunction(isLeaf: true);
