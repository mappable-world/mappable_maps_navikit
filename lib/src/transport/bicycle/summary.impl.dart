...
final _BicycleSummary_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_bicycle_BicycleSummary_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _BicycleSummary_init = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleSummary_init')
        ...
        .lookup<
                ffi.NativeFunction<
                    transport_bicycle_weight.BicycleWeightNative Function(
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_bicycle_BicycleSummary_get_weight')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _BicycleSummary_get_flags = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleSummary_get_flags')
        .asFunction(isLeaf: true);
