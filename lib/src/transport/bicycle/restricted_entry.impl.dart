...
final _BicycleRestrictedEntry_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_bicycle_BicycleRestrictedEntry_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        mapkit_geometry_geometry.PolylinePositionNative)>>(
            'mappable_flutter_transport_bicycle_BicycleRestrictedEntry_init')
...
final mapkit_geometry_geometry.PolylinePositionNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_bicycle_BicycleRestrictedEntry_get_position')
    .asFunction(isLeaf: true);
