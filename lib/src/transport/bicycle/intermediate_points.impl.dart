...
final _BicycleViaPoint_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_bicycle_BicycleViaPoint_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleViaPoint_init')
...
final mapkit_geometry_geometry.PolylinePositionNative Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleViaPoint_get_position')
        .asFunction(isLeaf: true);
...
final _BicycleWayPoint_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_bicycle_BicycleWayPoint_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_bicycle_BicycleWayPoint_init')
        .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_point.PointNative Function(
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_bicycle_BicycleWayPoint_get_position')
        .asFunction(isLeaf: true);
final ffi.Pointer<ffi.Void> Function(
    ffi
    ...
    .lookup<
        ...
        'mappable_flutter_transport_bicycle_BicycleWayPoint_get_selectedArrivalPoint')
    .asFunction(isLeaf: true);
