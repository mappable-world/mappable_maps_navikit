...
final _BicycleLeg_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Void)>>(
        'mappable_flutter_transport_bicycle_BicycleLeg_free');
...
final ffi.Pointer<ffi.Void> Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleLeg_init')
...
final transport_bicycle_weight.BicycleWeightNative Function(
    ...
    lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleLeg_get_weight')
        .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    mapkit_geometry_geometry.SubpolylineNative Function(
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_bicycle_BicycleLeg_get_geometry')
        .asFunction(isLeaf: true);
