...
final _BicycleRouter_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_transport_bicycle_BicycleRouter_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Int64,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_transport_bicycle_BicycleRouter_requestRoutes')
        .asFunction();
final ffi.Pointer<ffi.Void> Function(
    ...
    .lookup<
        ...
        'mappable_flutter_transport_bicycle_BicycleRouter_requestRoutesSummary')
    .asFunction();
final ffi.Pointer<ffi.Void> Function(
    ...
    _BicycleRouter_resolveUri = lib.library
        .lookup<
            ...
            'mappable_flutter_transport_bicycle_BicycleRouter_resolveUri')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _BicycleRouter_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_transport_bicycle_BicycleRouter_set_')
