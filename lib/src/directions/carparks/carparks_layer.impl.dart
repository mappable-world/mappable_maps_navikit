...
final _CarparksLayer_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_carparks_CarparksLayer_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _CarparksLayer_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_carparks_CarparksLayer_check')
    .asFunction(isLeaf: true);

final core.bool Function(ffi.Pointer<ffi.Void>) _CarparksLayer_isVisible = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_carparks_CarparksLayer_isVisible')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.bool)
    _CarparksLayer_setVisible = lib.library
        .lookup<
            ...
            'mappable_flutter_directions_carparks_CarparksLayer_setVisible')
        .asFunction();
final core.bool Function(
    ffi.Pointer<ffi.Void>,
    native_types
        .NativeString) _CarparksLayer_setCarparksStyle = lib.library
    .lookup<
            ffi.NativeFunction<
                ffi.Bool Function(
                    ffi.Pointer<ffi.Void>, native_types.NativeString)>>(
        'mappable_flutter_directions_carparks_CarparksLayer_setCarparksStyle')
    .asFunction();
final core.bool Function(
    ffi.Pointer<ffi.Void>,
    core.int,
    ...
    .lookup<
        ...
        'mappable_flutter_directions_carparks_CarparksLayer_setCarparksStyleWithId')
    .asFunction();
final void Function(
    ffi
        .Pointer<ffi.Void>) _CarparksLayer_resetCarparksStyles = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_carparks_CarparksLayer_resetCarparksStyles')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _CarparksLayer_set = lib
    ...
    .lookup<
        ...
        'mappable_flutter_directions_carparks_CarparksLayer_set_')
    .asFunction(isLeaf: true);
