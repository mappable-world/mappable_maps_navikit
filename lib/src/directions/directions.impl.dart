...
final _Directions_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_Directions_free');
final core.bool Function(ffi.Pointer<ffi.Void>) _Directions_check = lib.library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_Directions_check')
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_directions_Directions_createCarparksLayer')
        .asFunction();
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>, core.int)
    _Directions_createDrivingRouter = lib.library
        .lookup<
            ...
            'mappable_flutter_directions_Directions_createDrivingRouter')
        .asFunction();
    ...
    .lookup<
        ffi.NativeFunction<
            ffi.Void Function(ffi.Pointer<ffi.Void>,
                ffi.Int64)>>('mappable_flutter_directions_Directions_set_')
    .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function() _DirectionsFactory_get_instance = lib
    ...
    .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
        'mappable_flutter_directions_DirectionsFactory_get_instance')
    .asFunction(isLeaf: true);
