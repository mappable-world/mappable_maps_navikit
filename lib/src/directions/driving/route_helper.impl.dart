        ...
        .lookup<
                ffi.NativeFunction<
                    ArrowManeuverStyleNative Function(
                        ...
                        ffi.Float,
                        ffi.Bool)>>(
            'mappable_flutter_directions_driving_ArrowManeuverStyle_init')
        ...
        .lookup<
                ffi.NativeFunction<
                    PolygonManeuverStyleNative Function(
                        ...
                        ffi.Float,
                        ffi.Bool)>>(
            'mappable_flutter_directions_driving_PolygonManeuverStyle_init')
        .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    ManeuverStyleNative Function(
                        ArrowManeuverStyleNative, PolygonManeuverStyleNative)>>(
            'mappable_flutter_directions_driving_ManeuverStyle_init')
        .asFunction(isLeaf: true);
...
final ffi.Pointer<ffi.Void> Function() _RouteHelper_createDefaultJamStyle = lib
    ...
    .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
        'mappable_flutter_directions_driving_RouteHelper_createDefaultJamStyle')
    .asFunction();
final ffi.Pointer<ffi.Void> Function() _RouteHelper_createDisabledJamStyle = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>(
        'mappable_flutter_directions_driving_RouteHelper_createDisabledJamStyle')
    .asFunction();
final ManeuverStyleNative Function() _RouteHelper_createDefaultManeuverStyle = lib
    ...
    .lookup<ffi.NativeFunction<ManeuverStyleNative Function()>>(
        'mappable_flutter_directions_driving_RouteHelper_createDefaultManeuverStyle')
    .asFunction();
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        ffi.Bool)>>(
            'mappable_flutter_directions_driving_RouteHelper_updatePolyline')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _RouteHelper_addManeuvers = lib.library
        .lookup<
            ...
            'mappable_flutter_directions_driving_RouteHelper_addManeuvers')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _RouteHelper_addJams = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_directions_driving_RouteHelper_addJams')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)
    _RouteHelper_applyJamStyle = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Void Function(
                        ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_directions_driving_RouteHelper_applyJamStyle')
        .asFunction();
final void Function(ffi.Pointer<ffi.Void>, ManeuverStyleNative)
    _RouteHelper_applyManeuverStyle = lib.library
        .lookup<
            ...
            'mappable_flutter_directions_driving_RouteHelper_applyManeuverStyle')
        .asFunction();
