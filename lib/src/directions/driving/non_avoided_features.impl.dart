...
final DrivingNonAvoidedFeaturesNative Function(
    core.bool,
    core.bool,
    core.bool,
    core.bool,
    ...
    core.bool,
    core
        .bool) _DrivingNonAvoidedFeaturesNativeInit = lib.library
    .lookup<
            ffi.NativeFunction<
                DrivingNonAvoidedFeaturesNative Function(
                    ...
                    ffi.Bool,
                    ffi.Bool)>>(
        'mappable_flutter_directions_driving_DrivingNonAvoidedFeatures_init')
