...
final DrivingVehicleRestrictionNative Function(
    ...
    ffi.Pointer<ffi.Void>,
    ffi
        .Pointer<ffi.Void>) _DrivingVehicleRestrictionNativeInit = lib.library
    .lookup<
            ffi.NativeFunction<
                DrivingVehicleRestrictionNative Function(
                    ...
                    ffi.Pointer<ffi.Void>,
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_driving_DrivingVehicleRestriction_init')
...
final DrivingRoadVehicleRestrictionNative Function(
    ...
    .lookup<
        ...
        'mappable_flutter_directions_driving_DrivingRoadVehicleRestriction_init')
    .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    DrivingManoeuvreVehicleRestrictionNative Function(
                        DrivingVehicleRestrictionNative,
                        mapkit_geometry_geometry.PolylinePositionNative)>>(
            'mappable_flutter_directions_driving_DrivingManoeuvreVehicleRestriction_init')
        .asFunction(isLeaf: true);
