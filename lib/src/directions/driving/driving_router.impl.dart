...
final _DrivingTooComplexAvoidedZonesError_free = lib.library.lookup<
    ...
    'mappable_flutter_directions_driving_DrivingTooComplexAvoidedZonesError_free');
final core.bool Function(
    ffi
        .Pointer<ffi.Void>) _DrivingTooComplexAvoidedZonesError_check = lib
    .library
    .lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_driving_DrivingTooComplexAvoidedZonesError_check')
...
final void Function(
    ...
    .lookup<
        ...
        'mappable_flutter_directions_driving_DrivingTooComplexAvoidedZonesError_set_')
    .asFunction(isLeaf: true);
        ...
        .lookup<
                ffi.NativeFunction<
                    DrivingOptionsNative Function(
                        ...
                        ffi.Pointer<ffi.Void>,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_directions_driving_DrivingOptions_init')
        .asFunction(isLeaf: true);
...
final _DrivingRouter_free = lib.library
    .lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_driving_DrivingRouter_free');
        ...
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_directions_driving_DrivingRouter_requestRoutes')
        .asFunction();
final ffi.Pointer<ffi.Void> Function(
        ffi.Pointer<ffi.Void>,
        ffi.Pointer<ffi.Void>,
                ...
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(
                        ...
                        directions_driving_vehicle_options
                            .DrivingVehicleOptionsNative,
                        ffi.Pointer<ffi.Void>)>>(
            'mappable_flutter_directions_driving_DrivingRouter_matchRoute')
        .asFunction();
final ffi.Pointer<ffi.Void> Function(
    ffi.Pointer<ffi.Void>,
    ffi.Pointer<ffi.Void>,
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ...
                    directions_driving_vehicle_options.DrivingVehicleOptionsNative,
                    ffi.Pointer<ffi.Void>)>>(
        'mappable_flutter_directions_driving_DrivingRouter_requestRoutesSummary')
    .asFunction();
final void Function(ffi.Pointer<ffi.Void>, core.int) _DrivingRouter_set = lib
    ...
    .lookup<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>(
        'mappable_flutter_directions_driving_DrivingRouter_set_')
    .asFunction(isLeaf: true);
